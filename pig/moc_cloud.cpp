/****************************************************************************
** Meta object code from reading C++ file 'cloud.hpp'
**
...
#error "The header file 'cloud.hpp' doesn't include <QObject>."
...
const QMetaObject Pig::staticMetaObject = {
    { &ControlFigure::staticMetaObject, qt_meta_stringdata_Pig.data,
      qt_meta_data_Pig,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Pig::qt_metacast(const char *_clname)
{
    ...
    return ControlFigure::qt_metacast(_clname);
}

int Pig::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ControlFigure::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
